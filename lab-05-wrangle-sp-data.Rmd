...
***There are `r nrow(dn_lq_ak)` observations. The names of the variables in this data frame are `r names(dn_lq_ak)`.***
...
***Mitch Hedberg's joke is most likely to hold true in Texas because the code revealed that there are more Denny's locations near a La Quintas in Texas.***
